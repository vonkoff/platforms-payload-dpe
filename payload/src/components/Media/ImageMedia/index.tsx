...
export const ImageMedia: React.FC<MediaProps> = (props) => {
  ...
  const layout = fill ? "fullWidth" : "constrained";
  ...
  return (
    //INFO: If a CDN besides Cloudflare Image is used might have to wrap this in picture tag if they do not support it
    <Image
      alt={alt || ""}
